/********************************************************************************
** auth： Onelei
** date： 2017/7/4 14:52:00
** desc： 描述
** Ver.:  V1.0.0
*********************************************************************************/
using UnityEngine;

public class SampleStateB : StateMachine<UBState>
{
    public void SetState(UBState state)
    {
        //设置开始状态；
        mCurState = state;
        Debug.Log("SampleStateB 设置当前状态 " + state);
    }
    /// <summary>
    /// 开始；
    /// </summary>
    ...
    protected override void OnEnterState(UBState _state)
    {
        ...
        Debug.Log("SampleStateB 进入状态 " + mCurState);
    }
    /// <summary>
    /// 退出状态;
    /// </summary>
    ...
    protected override void OnExitState(UBState _state)
    {
        ...
        Debug.Log("SampleStateB 退出状态 " + mCurState);
    }
    /// <summary>
    /// 更新状态;
    /// </summary>
